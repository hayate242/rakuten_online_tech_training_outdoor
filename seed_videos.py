...
db_session.add(
    Videos(
        ...
        '',
        'https://www.youtube.com/embed/iY4hQd24_d0', 'exercise'
    )
)
db_session.add(
    Videos(
        ...
        '',
        'https://www.youtube.com/embed/fLLScgWQcHc', 'exercise'
    )
)
db_session.add(
    Videos(
        ...
        '',
        'https://www.youtube.com/embed/Ks-lKvKQ8f4', 'exercise'
    )
)
db_session.add(
    Videos(
        ...
        "The video is in full length which means you can just follow whatever I’m doing! 30 seconds each exercise – NO REST IN BETWEEN.",
        '',
        'https://www.youtube.com/embed/1fjeQKI-5wg', 'exercise'
    )
)
...
db_session.add(
    Videos(
        ...
        '',
        'https://www.youtube.com/embed/SpI3QF_Iauc', 'recipe'
    )
)
db_session.add(
    Videos(
        ...
        '',
        'https://www.youtube.com/embed/5vy9HeL8mOc', 'recipe'
    )
)
db_session.add(
    Videos(
        ...
        '',
        'https://www.youtube.com/embed/21rgi2Imq14', 'recipe'
    )
)
db_session.add(
    Videos(
        ...
        '',
        'https://www.youtube.com/embed/-x2E7T3-r7k', 'recipe'
    )
)
db_session.commit()
